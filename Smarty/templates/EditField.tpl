...
<tr>
	...
	<form method="POST" action="index.php">
		...
		<tr>
			...
			<td class="cellText" width='30%'>
				<select name="tableid" class="small">
					...
					<option value="{$TABLE->id}" {if $FIELD->tableid eq $TABLE->id}selected=true{/if}>{$TABLE->tablename}</option>
					{/foreach}
				</select>
			</td>
		...
		<tr>	
			...
			<td class="cellText" width='30%'>
				<select name="blockid" class="small">
					...
					<option value="{$BLOCK->id}" {if $FIELD->blockid eq $BLOCK->id}selected=true{/if}>{$BLOCK->trlabel}</option>
					{/foreach}
				</select>
			</td>
		...
		<tr>
			...
			<td class="cellText" width='30%'>
				<select name="uitype" class="small">
					...
					<option value="{$UITYPE_KEY}" {if $FIELD->uitype eq $UITYPE_KEY}selected=true{/if}>{$UITYPE_LBL}</option>
					{/foreach}
				</select>
			</td>
		...
		<tr>
			...
			<td class="cellText" width='30%'>
				<input type="text" name="masseditable" class='textBox' size=40 value="{$FIELD->masseditable}">
