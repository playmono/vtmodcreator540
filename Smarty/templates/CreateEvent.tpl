...
<tr>
	...
	<form method="POST" action="index.php">
		...
		<tr>
			...
			<td class="cellText" width='30%'><input type='text' class='textBox' size=40 name='classname' value="{$MODULE->modulename}Handler" readonly></td>
		</tr>
		<tr>
			<td class="cellLabel" width='20%'><span class='required'>*</span>File</td>
			<td class="cellText" width='80%' colspan=3>
				<input type='text' class='textBox' size=60 name='filename' value="modules/{$MODULE->modulename}/{$MODULE->modulename}Handler.php" readonly>
		...
		<tr>
			...
			<td class="cellText" width='80%' colspan=3>
				...
				<textarea name="cond" class="small" rows=5 cols=80>modulename in ['{$MODULE->modulename}']</textarea>
			</td>
		</tr>
		<tr>
