...
class #MODULENAME# extends CRMEntity {
	 ...
	 */
	var $customFieldTable = Array('#CUSTOM_TABLENAME#', '#CUSTOM_TABLEINDEX#');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', '#TABLENAME#', '#CUSTOM_TABLENAME#');
	...
	var $tab_name_index = Array(
		...
		'#CUSTOM_TABLENAME#'=>'#CUSTOM_TABLEINDEX#');
	...
	var $list_fields = Array (
		...
		'#ENTITY_FIELDLABEL#' => Array('#ENTITY_FIELDTABLE#', '#ENTITY_FIELDCOLUMN#'),
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'#ENTITY_FIELDLABEL#' => '#ENTITY_FIELDNAME#',
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view 
	var $list_link_field = '#ENTITY_FIELDNAME#';
	...
	var $popup_fields = Array ('#ENTITY_FIELDNAME#');

	// Allow sorting on the following (field column names)
	var $sortby_fields = Array ('#ENTITY_FIELDCOLUMN#');

	// Should contain field labels
	//var $detailview_links = Array ('#ENTITY_FIELDLABEL#');

	// For Alphabetical search
	var $def_basicsearch_col = '#ENTITY_FIELDCOLUMN#';

	// Column value to use on detail view record text display
	var $def_detailview_recname = '#ENTITY_FIELDNAME#';

	// Required Information for enabling Import feature
	var $required_fields = Array ('#MANDATORY_FIELDNAME#'=>1);

	// Callback function list during Importing
	var $special_functions = Array('set_import_assigned_user');

	var $default_order_by = '#ENTITY_FIELDNAME#';
	var $default_sort_order='ASC';
	
	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('createdtime', 'modifiedtime', '#ENTITY_FIELDNAME#');
